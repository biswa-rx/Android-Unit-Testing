...
import com.example.androidunittesting.local.Quote
import com.example.androidunittesting.local.QuoteDatabase
import com.example.androidunittesting.local.QuotesDao
...
class QuotesDaoTest {
    ...
    fun insertQuote_expectedSingleQuote() = runBlocking {
        val quote = Quote(0,"This is a test quote","biswa")
